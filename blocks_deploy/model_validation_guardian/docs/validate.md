...
- Canonical file: `data/yield_data.csv`
- Data rows: **118**
- Columns: **61**
...
- Asset snapshot coverage: **59** source-backed, **0** canonical-only.
- Normalized quote exports: **59** per-asset files; statuses: {'source_snapshot': 59}.
