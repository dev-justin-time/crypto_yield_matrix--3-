"""Generated native Blocks adapter for yield_methodology_expert.

Source card: blocks_agents/yield_methodology_expert.json
...
from blocks_agents.handlers.yield_methodology_expert import handler as local_handler
